...
-(void)showTrueIcon
{
    UIImageView* tTrueImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 25, 25)];
    tTrueImageView.image = [UIImage imageNamed:IconTrueImageName];
    self.rightView=tTrueImageView;
...
-(void)showErrorIconForMsg:(NSString *)msg{
    ...
    [btnError setBackgroundImage:[UIImage imageNamed:IconFalseImageName] forState:UIControlStateNormal];
